 ...
 * @since 1.0.0
 */
class Ricci_Blog_Featured extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Ricci Blog Featured', 'ricci-core-addon' );
	}
	...
	?>
	<div class="ricci-blog-section featured-posts">
	<?php
